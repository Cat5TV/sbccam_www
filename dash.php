...
<head>
    <!-- Title -->
    <title>Hide Sidebar | Unify - Responsive Website Template</title>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="https://cdn.zecheriah.com/site-assets/2.5.1/favicon.ico">
    <!-- Google Fonts -->
    <link rel="stylesheet" href="//fonts.googleapis.com/css?family=Open+Sans%3A400%2C300%2C500%2C600%2C700%7CPlayfair+Display%7CRoboto%7CRaleway%7CSpectral%7CRubik">
    <!-- CSS Global Compulsory -->
    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/bootstrap/bootstrap.min.css">
    <!-- CSS Global Icons -->
    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/icon-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/icon-line/css/simple-line-icons.css">
    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/icon-etlinefont/style.css">
    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/icon-line-pro/style.css">
    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/icon-hs/style.css">

    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/vendor/hs-admin-icons/hs-admin-icons.css">

    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/animate.css">
    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/malihu-scrollbar/jquery.mCustomScrollbar.min.css">

    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/vendor/flatpickr/dist/css/flatpickr.min.css">
    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/vendor/bootstrap-select/css/bootstrap-select.min.css">

    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/vendor/chartist-js/chartist.min.css">
    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/vendor/chartist-js-tooltip/chartist-plugin-tooltip.css">
    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/fancybox/jquery.fancybox.min.css">

    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/hamburgers/hamburgers.min.css">

    <!-- CSS Unify -->
    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/css/unify-admin.css">

    <!-- CSS Customization -->
    <link rel="stylesheet" href="https://cdn.zecheriah.com/site-assets/2.5.1/assets/css/custom.css">
</head>
...
<body>
        ...
        <div class="u-header__section u-header__section--admin-dark g-min-height-65">
            <nav class="navbar no-gutters g-pa-0">
                <div class="col-auto d-flex flex-nowrap u-header-logo-toggler g-py-12">
                    ...
                    <!-- Sidebar Toggler -->
                    <a class="js-side-nav u-header__nav-toggler d-flex align-self-center ml-auto" href="#!" data-hssm-class="u-side-nav--hidden u-sidebar-navigation-v1--hidden" data-hssm-body-class="u-side-nav-hidden" data-hssm-is-close-all-except-this="true" data-hssm-target="#sideNav" data-hssm-widgets="#sideNavWidgets">
                            ...
                            <ul class="p-0 mb-0">
                                ...
                                <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                                    <div class="d-flex g-mr-15">
                                        <img class="g-width-40 g-height-40 rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img5.jpg" alt="Image Description">
                                    </div>
                                ...
                                <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                                    <div class="d-flex g-mr-15">
                                        <img class="g-width-40 g-height-40 rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img6.jpg" alt="Image Description">
                                    </div>
                                ...
                                <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                                    <div class="d-flex g-mr-15">
                                        <img class="g-width-40 g-height-40 rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                    </div>
                        ...
                        <div class="g-pos-rel g-px-10--lg">
                            <a id="profileMenuInvoker" class="d-block" href="#!" aria-controls="profileMenu" aria-haspopup="true" aria-expanded="false" data-dropdown-event="click" data-dropdown-target="#profileMenu" data-dropdown-type="css-animation" data-dropdown-duration="300" data-dropdown-animation-in="fadeIn" data-dropdown-animation-out="fadeOut">
                                <span class="g-pos-rel">
                                  ...
                                  <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle g-mr-10--sm" src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/img-temp/130x130/img1.jpg" alt="Image description">
                                </span>
                ...
                <ul id="sideNavMenu" class="u-sidebar-navigation-v1-menu u-side-nav--top-level-menu g-min-height-100vh mb-0">
                    ...
                    <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--top-level-menu-item">
                        <a class="media u-side-nav--top-level-menu-link u-side-nav--hide-on-hidden g-px-15 g-py-12" href="#!" data-hssm-target="#subMenu1">
                            ...
                            <span class="media-body align-self-center">Input</span>
                        ...
                        <ul id="subMenu1" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0">
                            ...
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/dashboards/dashboard-v1.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                                      <i class="hs-admin-infinite"></i>
                                    </span>
                                    <span class="media-body align-self-center">USB</span>
                                </a>
                            </li>
                            <!-- End Dashboards v1 -->
                            ...
                            <!-- Dashboards v2 -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/dashboards/dashboard-v2.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                                      <i class="hs-admin-blackboard"></i>
                                    </span>
                                    <span class="media-body align-self-center">RTSP</span>
                                </a>
                            </li>
                            <!-- End Dashboards v2 -->
                            ...
                            <!-- Dashboards v3 -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/dashboards/dashboard-v3.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                                      <i class="hs-admin-harddrive"></i>
                                    </span>
                                    <span class="media-body align-self-center">ONVIF</span>
                                </a>
                            </li>
                            <!-- End Dashboards v3 -->
                    ...
                    <!-- App Views -->
                    <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--top-level-menu-item">
                        <a class="media u-side-nav--top-level-menu-link u-side-nav--hide-on-hidden g-px-15 g-py-12" href="#!" data-hssm-target="#outputmenu">
                            <span class="d-flex align-self-center g-pos-rel g-font-size-18 g-mr-18">
                              <i class="hs-admin-layers"></i>
                            </span>
                            <span class="media-body align-self-center">Output</span>
                            <span class="d-flex align-self-center u-side-nav--control-icon">
                              <i class="hs-admin-angle-right"></i>
                            </span>
                        ...
                        <!-- App Views: Submenu-1 -->
                        <ul id="outputmenu" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0">
                            <!-- Profile Pages -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="#!" data-hssm-target="#outputmenustills">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                                      <i class="hs-admin-list"></i>
                                    </span>
                                    <span class="media-body align-self-center">Stills</span>
                                    <span class="d-flex align-self-center u-side-nav--control-icon">
                                      <i class="hs-admin-angle-right"></i>
                                    </span>
                                </a>
                                ...
                                <ul id="outputmenustills" class="u-side-nav--third-level-menu">

                                    <!-- Main -->
                                    <li class="u-side-nav--third-level-menu-item">
                                      <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/app-views/app-profile.html">Cloud</a>
                                    </li>
                                    <!-- End Main -->

                                    <!-- Biography -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/app-views/app-profile-biography.html">FTP</a>
                                    </li>
                                    <!-- End Biography -->

                                    <!-- Interests -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/app-views/app-profile-interests.html">Internal Storage</a>
                                    </li>
                                    <!-- End Interests -->

                                    <!-- Mobile -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/app-views/app-profile-mobile.html">USB Storage</a>
                                    </li>
                                    <!-- End Mobile -->

                                    <!-- Photos & Videos -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/app-views/app-profile-photos-and-videos.html">NAS Storage</a>
                                    </li>
                                    <!-- End Photos & Videos -->

                                    <!-- Biography -->
                                    <li class="u-side-nav--third-level-menu-item">
                                      <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/app-views/app-profile-biography.html">Email</a>
                                    </li>
                                    <!-- End Biography -->
                            ...
                            <!-- Profile Pages -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="#!" data-hssm-target="#outputmenuvideo">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                                      <i class="hs-admin-list"></i>
                                    </span>
                                    <span class="media-body align-self-center">Video</span>
                                    <span class="d-flex align-self-center u-side-nav--control-icon">
                                      <i class="hs-admin-angle-right"></i>
                                    </span>
                                </a>
                                ...
                                <!-- Menu Leveles: Submenu-2 -->
                                <ul id="outputmenuvideo" class="u-side-nav--third-level-menu">
                                    <!-- Main -->
                                    <li class="u-side-nav--third-level-menu-item">
                                      <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/app-views/app-profile.html">YouTube Live</a>
                                    </li>
                                    <!-- End Main -->
                    ...
                    <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--top-level-menu-item u-side-nav-opened has-active">
                        ...
                        <ul id="subMenu2" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0" style="display: block;">
                            <!-- Header Static -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/layout-settings/header-static.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                            ...
                            <!-- Hide Sidebar -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12 active" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/layout-settings/sidebar-hide.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                            ...
                            <!-- Light Layout -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/layout-settings/layout-light.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                            ...
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/layout-settings/layout-dark-body-v2.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                                      <i class="hs-admin-layout-media-center-alt"></i>
                                    </span>
                            ...
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/layout-settings/layout-light-body-v2.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                                      <i class="hs-admin-layout-media-center-alt"></i>
                                    </span>
                        ...
                        <ul id="subMenu7" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0">
                            ...
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--second-level-menu-item">
                                ...
                                <ul id="subMenu7Elements" class="u-side-nav--third-level-menu">
                                    <!-- Text Inputs -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-text-inputs.html">Text Inputs</a>
                                    </li>
                                    <!-- End Text Inputs -->

                                    <!-- Textareas -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-textareas.html">Textareas</a>
                                    </li>
                                    <!-- End Textareas -->

                                    <!-- Text Editors -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-text-editors.html">Text Editors</a>
                                    </li>
                                    <!-- End Text Editors -->

                                    <!-- Selects -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-selects.html">Selects</a>
                                    </li>
                                    <!-- End Selects -->

                                    <!-- Advanced Selects -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-advanced-selects.html">Advanced Selects</a>
                                    </li>
                                    <!-- End Advanced Selects -->

                                    <!-- Checkboxes &amp; Radios -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-checkboxes-radios.html">Checkboxes &amp; Radios</a>
                                    </li>
                                    <!-- End Checkboxes &amp; Radios -->

                                    <!-- Toggles -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-toggles.html">Toggles</a>
                                    </li>
                                    <!-- End Toggles -->

                                    <!-- File Inputs -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-file-inputs.html">File Inputs</a>
                                    </li>
                                    <!-- End File Inputs -->

                                    <!-- Sliders -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-sliders.html">Sliders</a>
                                    </li>
                                    <!-- End Sliders -->

                                    <!-- Text Inputs with Tags -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-tags.html">Text Inputs with Tags</a>
                                    </li>
                                    <!-- End Text Inputs with Tags -->

                                    <!-- Ratings -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-ratings.html">Ratings</a>
                                    </li>
                                    <!-- End Ratings -->

                                    <!-- Datepickers -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-datepickers.html">Datepickers</a>
                                    </li>
                                    <!-- End Datepickers -->

                                    <!-- Quantities -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-elemets-quantities.html">Quantities</a>
                                    </li>
                                    <!-- End Quantities -->
                                </ul>
                                <!-- End Menu Leveles: Submenu-2 -->
        ...
        <span class="media-body align-self-center">Layouts</span>
                            ...
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--second-level-menu-item">
                                ...
                                <ul id="subMenu7Validation" class="u-side-nav--third-level-menu">
                                    <!-- States -->
                                    <li class="u-side-nav--third-level-menu-item">
                                        <a class="u-side-nav--third-level-menu-link u-side-nav--hide-on-hidden g-pl-8 g-pr-15 g-py-6" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/forms/forms-validation-states.html">States</a>
                                    </li>
                                    <!-- End States -->
                                </ul>
                                <!-- Validation: Submneu -->
                    ...
                    <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--top-level-menu-item">
                        ...
                        <ul id="subMenu8" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0">
                            <!-- Basic Tables -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/tables/tables-basic.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                            ...
                            <!-- Table Designs -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/tables/tables-complex.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                    ...
                    <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--top-level-menu-item">
                        ...
                        <ul id="subMenu6" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0">
                            <!-- Panel Variations -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/panels/panel-variations.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                            ...
                            <!-- Panel with Tabs -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/panels/panel-options.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
    ...
    End Panel Options -->
                    ...
                    <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--top-level-menu-item">
                        ...
                        <ul id="subMenu9" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0">
                            ...
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/notifications/notifications-colorful.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                            ...
                            <!-- Light Notifications -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/notifications/notifications-light.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                                      <i class="hs-admin-layout-cta-btn-left"></i>
                                    </span>
                            ...
                            <!-- Dark Notifications -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/notifications/notifications-dark.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                                      <i class="hs-admin-layout-cta-center"></i>
                                    </span>
                            ...
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/notifications/notifications-builder.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                                      <i class="hs-admin-infinite"></i>
                                    </span>
                    ...
                    <li class="u-sidebar-navigation-v1-menu-item u-side-nav--top-level-menu-item">
                        <a class="media u-side-nav--top-level-menu-link u-side-nav--hide-on-hidden g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/metrics/metrics.html">
                            <span class="d-flex align-self-center g-pos-rel g-font-size-18 g-mr-18">
                    ...
                    <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--top-level-menu-item">
                        ...
                        <ul id="subMenu5" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0">
                            <!-- Icons -->
                            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/ui-components/ui-icons.html">
                                    <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                            ...
                            <!-- Buttons -->
                            <!--     <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
      <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/ui-components/ui-buttons.html">
        <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
        ...
        <span class="media-body align-self-center">Buttons</span>
                    ...
                    <!-- Timeline History -->
                    <li class="u-sidebar-navigation-v1-menu-item u-side-nav--top-level-menu-item">
                        <a class="media u-side-nav--top-level-menu-link u-side-nav--hide-on-hidden g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/pages/pages-timeline.html">
                            <span class="d-flex align-self-center g-pos-rel g-font-size-18 g-mr-18">
                    ...
                    <!-- Packages -->
                    <li class="u-sidebar-navigation-v1-menu-item u-side-nav--top-level-menu-item">
                        <a class="media u-side-nav--top-level-menu-link u-side-nav--hide-on-hidden g-px-15 g-py-12" href="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/packages.html">
                                    ...
                                    <section class="u-timeline-v2-wrap g-pos-rel g-left-25--before g-mb-20">
                                        <div class="g-orientation-left g-pos-rel g-ml-25--md g-pl-20">
                                            ...
                                            <div class="media g-mb-16">
                                                <div class="d-flex align-self-center g-mr-15">
                                                    <img class="g-width-55 g-height-55 rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img1.jpg" alt="Image Description">
                                                </div>
                                        ...
                                        <div class="g-orientation-left g-pos-rel g-ml-25--md g-pl-20">
                                            ...
                                            <div class="media g-mb-25">
                                                <div class="d-flex align-self-center g-mr-15">
                                                    <img class="g-width-55 g-height-55 rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img4.jpg" alt="Image Description">
                                                </div>
                                        ...
                                        <div class="g-orientation-left g-pos-rel g-ml-25--md g-pl-20">
                                            ...
                                            <div class="media g-mb-16">
                                                <div class="d-flex align-self-center g-mr-15">
                                                    <img class="g-width-55 g-height-55 rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img5.jpg" alt="Image Description">
                                                </div>
                                        ...
                                        <div class="g-orientation-left g-pos-rel g-ml-25--md g-pl-20">
                                            ...
                                            <div class="media g-mb-16">
                                                <div class="d-flex align-self-center g-mr-15">
                                                    <img class="g-width-55 g-height-55 rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                                </div>
                                            ...
                                            <ul class="list-inline d-flex g-mb-20">
                                                <li class="list-inline-item g-mb-10 g-mb-0--sm mr-0">
                                                    <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img4.jpg" alt="Image Description">
                                                </li>
                                                <li class="list-inline-item g-mb-10 g-mb-0--sm g-ml-7 mr-0">
                                                    <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                                </li>
                                                <li class="list-inline-item g-mb-10 g-mb-0--sm g-ml-7 mr-0">
                                                    <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img14.jpg" alt="Image Description">
                                                </li>
                                                <li class="list-inline-item g-mb-10 g-mb-0--sm g-ml-7 mr-0">
                                                    <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img15.jpg" alt="Image Description">
                                                </li>
                                                <li class="list-inline-item g-mb-10 g-mb-0--sm g-ml-7 mr-0">
                                ...
                                <div class="js-custom-scroll g-height-400 g-pa-15 g-pa-0-30-25--md">
                                    <section class="media">
                                        <div class="d-flex g-mr-12">
                                            <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img5.jpg" alt="Image Description">
                                        </div>
                                    ...
                                    <section class="media">
                                        <div class="d-flex g-mr-12">
                                            <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img14.jpg" alt="Image Description">
                                        </div>
                                    ...
                                    <section class="media">
                                        <div class="d-flex g-mr-12">
                                            <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                        </div>
    ...
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/vendor/jquery/jquery.min.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/vendor/jquery-migrate/jquery-migrate.min.js"></script>

    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/popper.min.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/bootstrap/bootstrap.min.js"></script>

    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/cookiejs/jquery.cookie.js"></script>

    <!-- jQuery UI Core -->
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/jquery-ui/ui/widget.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/jquery-ui/ui/version.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/jquery-ui/ui/keycode.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/jquery-ui/ui/position.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/jquery-ui/ui/unique-id.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/jquery-ui/ui/safe-active-element.js"></script>

    <!-- jQuery UI Helpers -->
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/jquery-ui/ui/widgets/menu.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/jquery-ui/ui/widgets/mouse.js"></script>

    <!-- jQuery UI Widgets -->
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/jquery-ui/ui/widgets/datepicker.js"></script>

    <!-- JS Plugins Init. -->
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/appear.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/vendor/bootstrap-select/js/bootstrap-select.min.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/vendor/flatpickr/dist/js/flatpickr.min.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/vendor/malihu-scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/vendor/chartist-js/chartist.min.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/vendor/chartist-js-tooltip/chartist-plugin-tooltip.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/vendor/fancybox/jquery.fancybox.min.js"></script>

    <!-- JS Unify -->
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/js/hs.core.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/js/components/hs.side-nav.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/js/helpers/hs.hamburgers.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/js/components/hs.range-datepicker.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/js/components/hs.datepicker.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/js/components/hs.dropdown.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/js/components/hs.scrollbar.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/js/components/hs.area-chart.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/js/components/hs.donut-chart.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/js/components/hs.bar-chart.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/js/helpers/hs.focus-state.js"></script>
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/admin-template/assets/js/components/hs.popup.js"></script>

    <!-- JS Custom -->
    <script src="https://cdn.zecheriah.com/site-assets/2.5.1/assets/js/custom.js"></script>
